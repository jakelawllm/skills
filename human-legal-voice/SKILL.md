...
Trust the reader. Delete the sentence that announces what the facts mean. State the fact and stop. If the point still is not obvious, add another concrete fact rather than an explanatory sentence.

Cut scaffolding and throat-clearing. Delete "I hope this email finds you well", "I am writing to", "further to the above", and any sentence that restates a conclusion already stated. State the point in the first line.
...
1. Does it open with the point, rather than throat-clearing ("we refer to the above matter and have carefully considered...")?
...
9. Does a list use a bolded label followed by a colon and a sentence restating the label?
10. Is any claim attributed to an unnamed authority ("industry reports suggest", "some critics argue")?
11. Are there three or more words from the elevated-frequency vocabulary list in one paragraph?
12. Does any sentence end with a shallow participial clause ("ensuring...", "highlighting...")?
13. Does any passage read like promotional or tourism copy?
14. Are there curly quotes or apostrophes anywhere in the document?
15. Is every citation and evidence reference verified to exist, accurately stated, and relevant, with nothing invented?
